...
let CountFeedback = require('./CountFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class CountActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new CountFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CountFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CountActionFeedback(null);
    ...
    data.feedback = CountFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CountActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = CountFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new CountFeedback()
    }
...
module.exports = CountActionFeedback;
