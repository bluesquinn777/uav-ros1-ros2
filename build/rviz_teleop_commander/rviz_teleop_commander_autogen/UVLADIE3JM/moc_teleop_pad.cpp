...
QT_INIT_METAOBJECT const QMetaObject rviz_teleop_commander::TeleopPanel::staticMetaObject = { {
    &rviz::Panel::staticMetaObject,
    qt_meta_stringdata_rviz_teleop_commander__TeleopPanel.data,
    qt_meta_data_rviz_teleop_commander__TeleopPanel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
